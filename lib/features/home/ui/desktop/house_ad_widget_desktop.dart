...
class HouseAdWidgetDesktop extends StatefulWidget {
  final House house;
  final int imgPathIndex;

  const HouseAdWidgetDesktop(
      {key, required this.house, required this.imgPathIndex});

  @override
  State<HouseAdWidgetDesktop> createState() => _HouseAdWidgetState();
}

class _HouseAdWidgetState extends State<HouseAdWidgetDesktop> {
  late House house;
                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      child: Icon(
                        ...
                        color:
                        house.isFavorite ? Colors.redAccent : Colors.black,
                      ),
                    ),
                  ),
                ),
