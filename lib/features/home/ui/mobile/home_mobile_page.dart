...
import 'package:workshopark/utils/widgets/custom_button.dart';
import 'package:workshopark/utils/common/constants.dart';
...
class _HomeMobilePageState extends State<HomeMobilePage> {
  final filterList = ['<\$100.000', '1 bedroom', '2 bedrooms','3 bedrooms','4 bedrooms', '2 bathrooms','3 bathrooms','4 bathrooms',];
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return FilterWidget(
                        ...
                        isActive:
                            activeFilter == filterList[index] ? true : false,
                        onBtnTap: () {
                          setState(() {
