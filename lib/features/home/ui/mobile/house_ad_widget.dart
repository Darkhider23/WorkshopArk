...
class HouseAdWidget extends StatefulWidget {
  ...
  const HouseAdWidget(
      {Key? key, required this.house, required this.imgPathIndex})
      : super(key: key);
...
class _HouseAdWidgetState extends State<HouseAdWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        constraints: const BoxConstraints(), // Set maximum width here
        child: FractionallySizedBox(
          widthFactor: 0.7, // Adjust this factor as needed
          child: Column(
